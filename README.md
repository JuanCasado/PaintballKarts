...
### A Slight chage
This project was discontinued for more than one year and since i was using the opencv library for robotics i decided to create a little 2d simulation of a car racing. It is far from the original prject but it was fun to create.
It is incredible how much you can archive by thinking before doing and by using every shortcut that maths provide.

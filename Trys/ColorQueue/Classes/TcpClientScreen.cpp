...
TcpClientScreen::TcpClientScreen(){
    this->failOcurred = false;
    this->succesOcurred = false;
}
...
bool TcpClientScreen::init(){
    ...
    auto nameLabel = Label::createWithTTF("name:", "./fonts/Marker Felt.ttf", 13);
    ...
    nameField = ui::TextField::create("Your Name","./fonts/Marker Felt.ttf",16);
    ...
    auto passLabel = Label::createWithTTF("password:", "./fonts/Marker Felt.ttf", 13);
    ...
    passField = ui::TextField::create("**********","./fonts/Marker Felt.ttf",16);
    ...
    auto ipLabel = Label::createWithTTF("ip:", "./fonts/Marker Felt.ttf", 13);
    ...
    ipField = ui::TextField::create("XXXX.XXXX.XXXX.XXXX","./fonts/Marker Felt.ttf",16);
    ...
    auto portLabel = Label::createWithTTF("port:", "./fonts/Marker Felt.ttf", 13);
    ...
    portField = ui::TextField::create("XXXX","./fonts/Marker Felt.ttf",16);
    ...
    auto bttLabel = Label::createWithTTF("Connect", "./fonts/Marker Felt.ttf", 19);
    bttLabel->setPosition(bttSize.width/2, bttSize.height/2);
    btt->addChild(bttLabel);
    
    banner = Label::createWithTTF("Try to Connect", "./fonts/Marker Felt.ttf", 16);
...
void TcpClientScreen::connectionSucceded(void){
    this->succesOcurred = true;
}
void TcpClientScreen::connectionFailed(void){
    this->failOcurred = true;
}

bool TcpClientScreen::TcpClient::isNumber(char c){
    return isdigit(c);
}
